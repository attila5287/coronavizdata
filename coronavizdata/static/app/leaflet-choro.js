// file below creates the USA map with state borders and legend thx2 leaflet
// <script type="text/javascript" src="/static/data/us-states.js"></script> 
// https://leafletjs.com/examples/choropleth/
// msg = 'testing app>leaflet-choropleth'
// console.log('msg :>> ', msg);
...
info.update = function (props) {
    this._div.innerHTML = '<h6 class="text-larger">US COVID-19 Deaths</h6>' +  
    
    (props ?
        '<b>' + props.name + '</b><br />' + props.deaths + ' deaths </sup>'
        : 'Hover over a state');
};
