...
// fetchTestTimeSer('Turkey');

fetchLatestData();

// fetchTestData();

function fetchTestTimeSer( chosenCountryName ) {

  const latestData4Table = prepData4TableAll( dataTimeJSON, chosenCountryName );
...
function fetchLatestTimeSer( chosenCountryName ) {
  ...
  d3.json( url, function ( error, data ) {
    ...
    const latestData4Table = prepData4TableAll( data, chosenCountryName );
    renderDynamicTable( latestData4Table );
    // const latestData = prepDataFromJSON( data, chosenCountryName );
    const latestData = prepDataFromJSON( data, chosenCountryName );
    // splatJSONTable( latestData );
...
function fetchTestData() {
  ...
  fetchTestTimeSer( defaultCountryName );
  ...
  d3.select( '#opts' )
    .on( 'change', function () {
      ...
      fetchTestTimeSer( chosenCountryName );

      console.log( 'staticData-chosenId***' );
